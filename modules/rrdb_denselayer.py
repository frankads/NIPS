...
from modules.torch_conv_kan_main.kan_convs.fast_kan_conv import FastKANConv2DLayer
...
class ResidualDenseBlock_out(nn.Module):
    def __init__(self, input, output, bias=True):
        ...
        self.kn1 = FastKANConv2DLayer(input, 32,3,padding = 1)
